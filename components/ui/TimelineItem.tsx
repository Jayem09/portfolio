export default function TimelineItem({ dates, title, subtitle, location, description, tags, action, isLast }: { dates: string; title: string; subtitle: string; location?: string; description?: string; tags?: string[]; action?: React.ReactNode; isLast?: boolean }) {
  return (
