  ...
  return (
    <header className="sticky top-0 z-40 backdrop-blur bg-white/80 dark:bg-ink/80 border-b border-dashed border-gray-200 dark:border-gray-800">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 h-14 flex items-center justify-between">
        <a href="#" className="font-semibold tracking-tight text-gray-900 dark:text-white">Your Name</a>
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="#" className="hidden sm:inline-flex bg-ink text-white dark:bg-white dark:text-black px-4 py-1.5 rounded-lg text-sm font-medium hover:scale-[1.02] transition-transform">View Resume</a>
        </div>
      </div>
    </header>
  );
